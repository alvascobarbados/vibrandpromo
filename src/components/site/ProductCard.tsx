      ...
      <div className="flex flex-1 flex-col p-3">
        ...
        <div className="mt-auto grid grid-cols-2 border-t border-border pt-3 text-center">
          <div className="min-w-0 pl-1 pr-2 sm:pr-3">
            <p className="whitespace-nowrap text-[clamp(5.5px,1.85vw,9px)] font-semibold uppercase leading-3 tracking-[-0.03em] text-muted-foreground">
              MOQ
            </p>
