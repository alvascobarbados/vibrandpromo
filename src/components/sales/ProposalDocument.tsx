...
function PageMarker({ page }: { page: number }) {
  return (
    <div className="proposal-no-print flex items-center gap-3 px-5 py-2 md:px-12">
...
export function ProposalDocument({
  ...
  return (
    <div className="proposal-doc">
      ...
      <header className="proposal-print-header px-5 pt-7 md:px-12 md:pt-8">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t border-n-200 px-5 py-5 md:px-12">
